...
#---- 
# Null model with random intercepts for subjects and bigrams and by-subject slopes for each component
#---- 
...
# Load model
lmm <- stan_model(file = "stanin/LMMsubjslopes.stan")
...
#Save model
saveRDS(m,
        file="stanout/LMMsubjslopes.rda",
        compress="xz")


# Traceplots
#param <- c("beta", "sigma", "u", "w") 

# Extract and save posterior and log likelihood seperately
# Get log likelihood
log_lik <- extract_log_lik(m) 
saveRDS(log_lik, 
        file = "stanout/log_lik/LMMsubjslopes_loglik.rda",
        compress = "xz")
...
saveRDS(samps, 
        file = "stanout/posterior/LMMsubjslopes_posterior.rda",
        compress = "xz")
...
saveRDS(re, 
        file = "stanout/RE/LMMsubjslopes_re.rda",
        compress = "xz")
